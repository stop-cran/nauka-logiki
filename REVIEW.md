...
повторяет то, что готовый текст говорит ниже и лучше, и они начинают расходиться. **Режь, а не
латай.**

**Схождение двух рецензентов есть знак достоверности**; **расхождение — знак идти к источнику**, а
не выбирать рецензента (обычно каждый прав наполовину).
