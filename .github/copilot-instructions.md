...
**Назови, что именно сверено.** Проверенное примечание, отсылающее к Клуге, не есть проверенная
статья Клуге; каталожная запись подтверждает указатель, а не содержание статьи. Называй издание и
место, какие прочитаны, отличая их от сообщения посредника и непроверенной наводки.
...
Русский допускает прочтения, каких английский подлинник не допускает. Следующие классы проверяй
в каждой новой вставке — они уже давали ошибку:
...
- **Владелец критерия в притяжательной конструкции.** В §27 «мы оспариваем … по собственному
  критерию … у Гегеля» допускало отнесение «собственному» к «мы», а не к Гегелю. Называй владельца
  однозначно: «по тому критерию …, какой формулирует сам Гегель». Проверяй и то, чей вывод
  обосновывается этим критерием: гегелевский критерий ещё не делает наш вывод словами Гегеля.
